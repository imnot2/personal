        ...
        n = function(a, c) {
            ...
            case "object":
                ...
                if (Object.prototype.toString.apply(b) === "[object Array]") {
                    g = b.length;
                    for (a = 0; a < g; a += 1) e[a] = n(a, b) || "null";
                    c = e.length === 0 ? "[]": f ? "[\n" + f + e.join(",\n" + f) + "\n" + j + "]": "[" + e.join(",") + 
                    "]";
                    f = j;
                    return c
                ...
                if (i && typeof i === "object") {
                    ...
                    for (a = 0; a < g; a += 1) {
                        d = i[a];
                        if (typeof d === "string") if (c = n(d, b)) e.push(q(d) + (f ? ": ": ":") + c)
                    }
                } else for (d in b) if (Object.hasOwnProperty.call(b, d)) if (c = n(d, b)) e.push(q(d) + (f ? ": ": ":") + c);
                c = e.length === 0 ? "{}": f ? "{\n" + f + e.join(",\n" + f) + "\n" + j + "}": "{" + e.join(",") + "}";
                f = j;
                return c
            }
        };
        if (typeof k.stringify !== "function") k.stringify = function(a, c, d) {
            var g;
            m = f = "";
            if (typeof d === "number") for (g = 0; g < d; g += 1) m += " ";
            else if (typeof d === "string") m = d;
            if ((i = c) && typeof c !== 
            "function" && (typeof c !== "object" || typeof c.length !== "number")) throw new Error("JSON.stringify");
            return n("", {
                "": a
            })
        };
        if (typeof k.parse !== "function") k.parse = function(a, c) {
            function d(g, j) {
                var e,
                b,
                h = g[j];
